...
export const PRODUCT_TEMPLATES: ProductTemplate[] = [
  { 
    name: 'T-Shirt (White)', 
    prompt: 'A high-quality professional studio mockup of a plain white t-shirt on a minimalist background. The logo provided should be placed naturally in the center of the chest.' 
  },
  { 
    name: 'T-Shirt (Black)', 
    prompt: 'A sleek black cotton t-shirt mockup, studio lighting, professional photography. The logo should be centered on the chest with realistic fabric deformation.' 
  },
  { 
    name: 'Hoodie', 
    prompt: 'A premium oversized hoodie mockup in charcoal grey. Professional e-commerce style. The logo is printed large on the front chest.' 
  },
  { 
    name: 'Coffee Mug', 
    prompt: 'A ceramic white coffee mug on a clean wooden table. Morning light. The logo is printed on the side of the mug with realistic curvature.' 
  },
  { 
    name: 'Tote Bag', 
    prompt: 'A canvas tote bag hanging on a simple hook. Minimalist aesthetic. The logo is centered on the bag.' 
  },
  { 
    name: 'Cap', 
    prompt: 'A classic baseball cap mockup, side view. The logo is embroidered or printed on the front panel.' 
  }
];
...
export const ICONS = {
  ...
  Flip: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18M5 8l-2 2 2 2M19 8l2 2-2 2" />
    </svg>
  ),
  Rotate: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
